...
class AgenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agency" do
    assert_difference('Agency.count') do
      post agencies_url, params: { agency: { clients: @agency.clients, domain: @agency.domain, image_url: @agency.image_url, logo_url: @agency.logo_url, name: @agency.name, type: @agency.type } }
    end
  ...
  test "should update agency" do
    patch agency_url(@agency), params: { agency: { clients: @agency.clients, domain: @agency.domain, image_url: @agency.image_url, logo_url: @agency.logo_url, name: @agency.name, type: @agency.type } }
